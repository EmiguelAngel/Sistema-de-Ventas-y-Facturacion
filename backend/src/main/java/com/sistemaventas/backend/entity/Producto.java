...
/**
 * POJO legacy — usado como contenedor de datos en VentaResponse / FacturaPdfService.
 * NO es una entidad JPA; el mapeo ORM lo hace ProductoJpaEntity.
 */
public class Producto {
    ...
    public void aumentarStock(int cantidad) {
        this.cantidadDisponible = (this.cantidadDisponible == null) ? cantidad : this.cantidadDisponible + cantidad;
    }

    @Override
    public String toString() {
        return "Producto{idProducto=" + idProducto + ", descripcion='" + descripcion + "', categoria='" + categoria + "'}";
    }
}
