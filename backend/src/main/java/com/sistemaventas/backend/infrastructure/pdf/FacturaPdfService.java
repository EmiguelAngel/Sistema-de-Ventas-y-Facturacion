package com.sistemaventas.backend.infrastructure.pdf;
...
public class FacturaPdfService {
    ...
    public byte[] generarFacturaPdf(Factura factura) {
        try {
            ...
            document.add(new Paragraph("Sistema POS - Tienda")
                .setFontSize(14).setBold().setTextAlignment(TextAlignment.CENTER).setMarginBottom(5));
            ...
            if (factura.getIdPago() != null) {
                document.add(new Paragraph(" ").setMarginBottom(10));
                document.add(new Paragraph("INFORMACIÓN DE PAGO").setFontSize(14).setBold().setMarginBottom(10));
                document.add(new Paragraph("ID Pago: " + factura.getIdPago()).setFontSize(10));
            }
    ...
    private Cell createTotalLabelCell(String text) {
        return new Cell()
            ...
            .setTextAlignment(TextAlignment.RIGHT).setBorder(null).setPadding(3);
    }
