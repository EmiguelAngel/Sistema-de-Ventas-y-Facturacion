package com.sistemaventas.backend.infrastructure.web.dto.request;
...
public class VentaRequest {
    ...
    public DatosPago getDatosPago() { return datosPago; }
    public void setDatosPago(DatosPago datosPago) { this.datosPago = datosPago; }
    ...
    public String toString() {
        return "VentaRequest{idUsuario=" + idUsuario + ", items=" + items + ", datosPago=" + datosPago + '}';
    }
    ...
    public static class ItemVenta {
        ...
        @Override
        public String toString() {
            return "ItemVenta{idProducto=" + idProducto + ", cantidad=" + cantidad + '}';
        }
    }
    ...
    public static class DatosPago {
        ...
        public DatosPago(String metodoPago) { this.metodoPago = metodoPago; }
        ...
        @Override
        public String toString() {
            return "DatosPago{metodoPago='" + metodoPago + '\'' +
